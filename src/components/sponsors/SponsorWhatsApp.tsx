...
export default function SponsorWhatsApp() {
  return (
    ...
    >
      <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/30 hover:shadow-[#25D366]/50 transition-shadow duration-300">
