const packages = [
  {
    ...
    featured: false,
    benefits: [
      "Banner de tu marca o empresa en nuestro sitio web",
      "Presencia de logo en promoción gráfica y videos del evento (redes sociales, WhatsApp y email)",
      "Mención al inicio y cierre de la presentación",
    ],
  },
  {
    tier: "Gold",
    featured: true,
    benefits: [
      "Todo lo del paquete Silver",
      "Stand para representar tu marca o empresa en las ciudades de la convención",
      "Kit Marketing y Campañas del evento",
    ],
  },
  {
    tier: "Platinum",
    featured: false,
    benefits: [
      "Todo lo del paquete Gold",
      "Desayuno y brunch gourmet con líderes de proyectos",
      "Magazine con los proyectos de inversión de México, RD, Colombia y USA",
    ],
  },
];
