...
export default function ClubBenefits() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden club-light-alt">
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black mt-3 mb-4 leading-[0.95]"
            style={{ fontFamily: "'Bebas Neue', sans-serif" }}
          >
            ¿QUÉ INCLUYE EL{" "}
            <span className="marker-bg px-2">CLUB</span>?
          </h2>
          <div className="w-24 h-1 bg-black mx-auto mb-6 mt-4" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            <div
              key={i}
              className="group relative bg-white border-2 border-black p-8 transition-all duration-300 hover:bg-[var(--color-marker-yellow)] hover:-translate-y-1 animate-fade-in"
              style={{ animationDelay: `${0.1 + i * 0.08}s` }}
            >
              <div className="w-14 h-14 bg-[var(--color-marker-yellow)] flex items-center justify-center text-black mb-5 border-2 border-black group-hover:bg-black group-hover:text-[var(--color-marker-yellow)] transition-all duration-300">
                {b.icon}
              </div>
              <h3
              ...
              <p className="text-black/70 text-sm leading-relaxed group-hover:text-black/85 transition-colors">
                {b.desc}
              </p>
            </div>
          ))}
