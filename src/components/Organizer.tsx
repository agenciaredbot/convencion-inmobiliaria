      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 text-sm mb-4" style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic" }}>
            ...
            <div className="flex gap-3 mb-8">
              <a
                ...
                className="w-12 h-12 rounded-xl glass flex items-center justify-center text-white/80 hover:text-gold-500 hover:bg-white/[0.08] transition-all duration-300"
              >
