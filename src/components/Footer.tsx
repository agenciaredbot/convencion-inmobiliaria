      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/claudiariverarealestate/" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-gold-500 transition-colors">
            ...
            <a href="https://wa.me/17542804030" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-gold-500 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
