    ...
    <>
      ...
      {!open && (
        ...
        >
          {/* Text bubble */}
          <div
            className="bg-white text-navy-950 text-sm font-bold px-5 py-2.5 rounded-xl shadow-lg relative animate-bounce"
          >
            💬 ¿Tienes preguntas?
      ...
      {open && (
        <div
          className="fixed bottom-4 right-4 z-50 w-[440px] max-w-[calc(100vw-2rem)] h-[680px] max-h-[calc(100vh-2rem)] flex flex-col rounded-2xl overflow-hidden shadow-2xl shadow-black/40 border border-white/10 transition-all duration-300"
        >
          {/* Header */}
